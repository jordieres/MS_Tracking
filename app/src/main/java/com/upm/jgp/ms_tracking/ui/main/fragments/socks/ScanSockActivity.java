...
import static io.sensoria.sdk.enums.CoreStatus.*;
...
public class ScanSockActivity extends AppCompatActivity implements IPermissionsCallback, ICoreCallback, IServiceCallback, IScannerCallback, ActivityCompat.OnRequestPermissionsResultCallback {
...
//////Toolbar Settings//////
    ...
    public void connect(View view) {
        System.out.println("PULSAR BOT  CON");
        if (MainActivity.isSockConnected()) {
            core1.connect(deviceDiscovered);
            mac1 = deviceDiscovered.deviceMac;
            MainActivity.setSock1_mac_global(mac1);
            MainActivity.setSock1_Core_global(core1);
            ...
            mac2 = deviceDiscovered2.deviceMac;
            ...
            System.out.println("qqqqq " + MainActivity.getSock1_Core_global() + " q " + MainActivity.getSock1_Device_globalD() + " m " + MainActivity.getSock1_mac_global());
            System.out.println("qqqqq " + MainActivity.getSock2_Core_global() + " q " + MainActivity.getSock2_Device_globalD() + " m " + MainActivity.getSock2_mac_global());
            btnConnect.setEnabled(false);
        }
    }
...
//        btnDisconnect.setEnabled(false);
        System.out.println("STATUS ES: " + core.getStatus());
        if (core.getStatus()==CONNECTED) {
        }
...
//            btnStartScan.setEnabled(false);
    ...
    public void didPermissionsGranted(String[] permissions) {
        Toast.makeText(ScanSockActivity.this, this.getString(R.string.PERMISSION_GRANTED), Toast.LENGTH_SHORT).show();
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        for (int i = 0; i < grantResults.length; i++) {
            if (permissions[i] == Manifest.permission.ACCESS_FINE_LOCATION) {
                ...
                Toast.makeText(ScanSockActivity.this, this.getString(granted ? R.string.PERMISSION_GRANTED_LOCATION :
    ...
    public void didServiceEvent(DeviceDescriptor deviceDescriptor, ServiceType serviceType, ServiceEvent serviceEvent) {
        ...
        switch (serviceEvent) {
            case CONNECTED:
                System.out.println("AHORA ENABLED B4");
                break;
    ...
    public void didCoreEvent(Core core, DeviceDescriptor deviceDescriptor, CoreEvent coreEvent) {
        switch (coreEvent) {
            case INITIALIZED:
                didInitialized(core);
                System.out.println("AHORA ENABLED B1");
                btnStartScan.setEnabled(true);
                break;
    ...
    public void didScannerEvent(Scanner scanner, ScannerEvent scannerEvent) {
        switch (scannerEvent) {
            ...
            case SCANNING_COMPLETED:
                ...
                System.out.println("AHORA ENABLED B3");
                break;
        ...
        deviceListSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (MainActivity.isSockConnected()) {
                    ...
                    mac2 = deviceDiscovered.deviceMac;
