...
import com.upm.jgp.healthywear.ui.main.fragments.socks.NewSockSetup;
 ...
 * @since 2020
 */
public class TabWearablesActivity extends AppCompatActivity implements ServiceConnection, MMRSetupActivityFragment.FragmentSettings, MMR2SetupActivityFragment.FragmentSettings2, NewSockSetup.FragmentSettings{
    ...
    /////Sock1 App/////
    private static String mac_address_sock1;
    private static String mac_address_sock2;
    ...
    public final static String EXTRA_BT_DEVICE3 = "com.sensoria.sensorialibrary.StreamService.EXTRA_BT_DEVICE3";
    public final static String EXTRA_BT_DEVICE4 = "com.sensoria.sensorialibrary.DeviceDescriptos.EXTRA_BT_DEVICE4";
    public final static String EXTRA_BT_DEVICE5 = "com.sensoria.sensorialibrary.StreamService.EXTRA_BT_DEVICE5";
    public final static String EXTRA_BT_DEVICE6 = "com.sensoria.sensorialibrary.DeviceDescriptos.EXTRA_BT_DEVICE6";
    private static StreamingService btDevice_sock_ss;
    private static DeviceDescriptor btDevice_sock_dd;
    private static StreamingService btDevice_sock_ss2;
    private static DeviceDescriptor btDevice_sock_dd2;
...
*/
        ...
        if (incoming_device_type.equals("SmartBand")) {
            ...
            System.out.println("prueba system incoming device smartband");
            //}
        }
        /////SmartBand App/////
        ...
        if (incoming_device_type.equals("MMR")) {
            ...
            System.out.println("prueba system incoming device MMR");
        }
        /////MMRData App/////
        ...
        if (incoming_device_type.equals("MMR2")) {
            ...
            System.out.println("prueba system incoming device MMR2");
        }
        /////MMR2Data App/////

        /////Sock1Data App/////
        if (incoming_device_type.equals("Sock1") || incoming_device_type.equals("Sock2")) {
            //if(MainActivity.isMmrConnected()) {
            btDevice_sock_ss = getIntent().getParcelableExtra(EXTRA_BT_DEVICE3);
            btDevice_sock_dd = getIntent().getParcelableExtra(EXTRA_BT_DEVICE4);
            mac_address_sock1 = getIntent().getStringExtra("deviceaddress");
            btDevice_sock_ss2 = getIntent().getParcelableExtra(EXTRA_BT_DEVICE5);
            btDevice_sock_dd2 = getIntent().getParcelableExtra(EXTRA_BT_DEVICE6);
            mac_address_sock2 = getIntent().getStringExtra("deviceaddress");
            System.out.println("prueba system incoming device sock1");
            System.out.println("mac_address_sock1 " + mac_address_sock1);

                getApplicationContext().bindService(new Intent(this, SensoriaCoreStreamingServiceActivity.class), this, BIND_AUTO_CREATE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menuBackToScan:
                System.out.println("prueba system onOptionsItemSelected case menuBackToScan");
            ...
            case R.id.menuDisconnectDevice:
                ...
                switch (selectedTab) {
                    case 0: //SmartBand
                        if (MainActivity.isSmartbandConnected()) {
                            System.out.println("prueba system onOptionsItemSelected case 0");
                            ...
                            System.out.println("prueba system onOptionsItemSelected case 0 else");
                            Toast.makeText(this, "No SmartBand is connected", Toast.LENGTH_SHORT).show();
                        }
                        break;
                    case 1: //MMR
                        if (MainActivity.isMmrConnected()) {
                            System.out.println("prueba system onOptionsItemSelected case 1");
                            ...
                            System.out.println("prueba system onOptionsItemSelected case 1 else");
                    ...
                    case 2: //MMR2
                        if (MainActivity.isMmr2Connected()) {
                            ...
                            System.out.println("prueba system onOptionsItemSelected case 2");
                            ...
                            System.out.println("prueba system onOptionsItemSelected case 2 else");
                            Toast.makeText(this, "No MMR2 device is connected", Toast.LENGTH_SHORT).show();
                        }
                        break;
                    case 3: //Sock1
                        if (MainActivity.isSock1Connected1()) {
                            System.out.println("prueba system onOptionsItemSelected case 3");
                            //Case for disconnection of smartband device
                            MainActivity.setSock1_device_global(null);
                            Toast.makeText(this, "Sock1 disconnected", Toast.LENGTH_SHORT).show();
                            //Change the view of that tab to device disconnected, if there is other device still connected
                            refreshTabs(3);
                        } else {
                            System.out.println("prueba system onOptionsItemSelected case 3 else");
                            Toast.makeText(this, "No Sock1 is connected", Toast.LENGTH_SHORT).show();
                        }
                        break;
                    case 4: //Sock2
                        if (MainActivity.isSock2Connected2()) {
                            System.out.println("prueba system onOptionsItemSelected case 4");
                            //Case for disconnection of smartband device
                            MainActivity.setSock2_device_global(null);
                            Toast.makeText(this, "Sock2 disconnected", Toast.LENGTH_SHORT).show();
                            //Change the view of that tab to device disconnected, if there is other device still connected
                            refreshTabs(4);
                        } else {
                            System.out.println("prueba system onOptionsItemSelected case 4 else");
                            Toast.makeText(this, "No Sock2 is connected", Toast.LENGTH_SHORT).show();
                        }
                        break;
                    case 5: //Others
                ...
                if ((!MainActivity.isSmartbandConnected()) && (!MainActivity.isMmrConnected()) && (!MainActivity.isMmr2Connected()) && (!MainActivity.isSock1Connected1()) && (!MainActivity.isSock2Connected2())) {
                    //Toast.makeText(this, "Nodeviceconnecteeeeed", Toast.LENGTH_SHORT).show();
                    if (popupInfo != null) {
                        popupInfo.dismiss();
                    }
                    System.out.println("prueba system onOptionsItemSelected fin");
            ...
            case R.id.menuInfo:
                System.out.println("prueba system onOptionsItemSelected menuInfo");
    ...
    private void inflateInfoPopup(int selectedTab) {
        ...
        switch (selectedTab) {
            case 0: //SmartBand
                System.out.println("prueba system inflateInfoPopup case 0");
                //Inflate the smartband layout/view
                customView = inflater.inflate(R.layout.activity_smartband_info_popup, null);
                break;
            case 1: //MMR
                System.out.println("prueba system inflateInfoPopup case 1");
                //Inflate the mmr layout/view
                customView = inflater.inflate(R.layout.activity_mmr_info_popup, null);
                break;
            case 2: //MMR2
                System.out.println("prueba system inflateInfoPopup case 2");
                //Inflate the mmr layout/view
                customView = inflater.inflate(R.layout.activity_mmr2_info_popup, null);
                break;
            case 3: //Sock1
                System.out.println("prueba system inflateInfoPopup case 3");
                //Inflate the mmr layout/view
                customView = inflater.inflate(R.layout.activity_sock1_info_popup, null);
                break;
            case 4: //Sock2
                System.out.println("prueba system inflateInfoPopup case 4");
                //Inflate the mmr layout/view
                customView = inflater.inflate(R.layout.activity_sock1_info_popup, null);
                break;
            default:
    ...
    @Override
    public DeviceDescriptor getBtDevice_sock1() {
        return btDevice_sock_dd;
    }
    ...
    public static String getMac_address_sock1() {
        return mac_address_sock1;
    }
    public static String getMac_address_sock2() {
        return mac_address_sock2;
    }
    ...
    public static void refreshTabs(int tabToRefresh) {
        ...
        System.out.println("prueba system refreshTabs");
        if (diff < 2) {
            System.out.println("prueba system  refreshTabs diff < 2");
    ...
    public static boolean isRefreshingTabs() {
        System.out.println(" prueba system isRefreshingTabs");
