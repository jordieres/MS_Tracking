...
public class MMR2SetupActivityFragment extends Fragment implements ServiceConnection {
    ...
    private static Activity  owner_mmr2;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        owner_mmr2 = getActivity();
        if (!( owner_mmr2 instanceof FragmentSettings2)) {
            throw new ClassCastException("Owning activity must implement the FragmentSettings interface");
        }

        settings = (FragmentSettings2)  owner_mmr2;
        owner_mmr2.getApplicationContext().bindService(new Intent( owner_mmr2, BtleService.class), this, Context.BIND_AUTO_CREATE);
    ...
    private String folderPathtmp2 = Environment.getExternalStorageDirectory().getPath() + File.separator + "tmp2" + File.separator + "cache" + File.separator;
    ...
    public void countn2() {
        if (n % 750 == 0 || n2 % 750 == 0 || n3 % 750 == 0) {
            ...
            if (n > n2) {
                if (n > n3) {
                    System.out.println("El mayor en MMR2 es n: " + n);
                } else {
                    System.out.println("el mayor en MMR2 es n3: " + n3);
                }
            } else if (n2 > n3) {
                System.out.println("el mayor en MMR2 es n2: " + n2);
            } else {
                System.out.println("el mayor en MMR2 es n3: " + n3);
            }
             */
            ...
            // PARA GYR
            System.out.println("crear fichero gyr en tmp2");
            //TODO Modify USER, PASSWORD and DBNAME from your MongoDB
            String toplinesGyr = "{'us':'USER','pass':'PASSWORD','db':'DBNAME','collection':'mmrp2_gyr'}\n" +
            ...
            System.out.println("writting to text file Gyr p2");
            ...
            // 20190409
            String txtnameGyr = folderPathtmp2 + shortname + "_gr";
            //create folder if not exist
            File folderfileGyr = new File(folderPathtmp2);
            ...
            if (txtfileGyr.exists()) {                 //check if txt file already existed
                File ftxtGyr = new File(folderPathtmp2);    //if exist count the number of files with this name
                int ntxt = 0;
            ...
            //PARA ACC
            System.out.println("crear fichero acc en tmp2");
            //TODO Modify USER, PASSWORD and DBNAME from your MongoDB
            String toplinesAcc = "{'us':'USER','pass':'PASSWORD','db':'DBNAME','collection':'mmrp2_acc'}\n" +
                    "{'mac':'" + metawear.getMacAddress() + "','appversion':'" + MainActivity.getStringAppVersion() + "'," + location + ",'alt':'" + ALT + "','t_end':'" + shortname + "','temp':'" + TEMP + "','illum':'" + ILLUM + "'}\n";
            ...
            //***Create text file and write data into it***
            System.out.println("writting to text file Acc p2");
            //System.out.println("count:"+count+"buffer:"+sb.toString());
            ...
            // 20190409
            String txtnameAcc = folderPathtmp2 + shortname + "_ac";
            //create folder if not exist
            File folderfileAcc = new File(folderPathtmp2);
            ...
            if (txtfileAcc.exists()) {                 //check if txt file already existed
                File ftxtAcc = new File(folderPathtmp2);    //if exist count the number of files with this name
                int ntxt = 0;
            ...
            //PARA MAG
            System.out.println("crear fichero magn en tmp2");
            //TODO Modify USER, PASSWORD and DBNAME from your MongoDB
            String toplinesMag = "{'us':'USER','pass':'PASSWORD','db':'DBNAME','collection':'mmrp2_mag'}\n" +
                    "{'mac':'" + metawear.getMacAddress() + "','appversion':'" + MainActivity.getStringAppVersion() + "'," + location + ",'alt':'" + ALT + "','t_end':'" + shortname + "','temp':'" + TEMP + "','illum':'" + ILLUM + "'}\n";
            ...
            //***Create text file and write data into it***
            System.out.println("writting to text file Magn p2");
            //System.out.println("count:"+count+"buffer:"+sb.toString());
            ...
            // 20190409
            String txtnameMag = folderPathtmp2 + shortname + "_mg";
            //create folder if not exist
            File folderfileMag = new File(folderPathtmp2);
            ...
            if (txtfileMag.exists()) {                 //check if txt file already existed
                File ftxtMag = new File(folderPathtmp2);    //if exist count the number of files with this name
                int ntxt = 0;
    ...
    public String compressTarGzip(String outputFile, List<String> inputFiles) throws IOException {
        ...
        try (OutputStream outputStream = Files.newOutputStream(Paths.get(outputFile));
            ...
            // System.out.println("Size " + gzf.length());
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        tv_gyr = view.findViewById(R.id.mmr2_value_gyr);    //Gyroscope data
        tv_arm = view.findViewById(R.id.mmr2_value_arm);    //arm angle
        tv_acc = view.findViewById(R.id.mmr2_value_acc);    //acceleration
        tv_mag = view.findViewById(R.id.mmr2_value_mag);    //Magnetometer data
                        ...
                        public void configure(RouteComponent source) {
                            ...
                            source.stream(new Subscriber() {
                                ...
                                public void apply(Data data, Object... env) {
                                    time_now = System.currentTimeMillis();
                                    n++;
                                    System.out.println("VALOR DE N  en p2 es " + n);
                        ...
                        public void configure(RouteComponent source) {
                            source.stream(new Subscriber() {
                                ...
                                public void apply(Data data, Object... env) {
                                    ...
                                    n2++;
                                    System.out.println("VALOR DE N2 en p2 es " + n2);
                        ...
                        public void configure(RouteComponent source) {
                            source.stream(new Subscriber() {
                                ...
                                public void apply(Data data, Object... env) {
                                    ...
                                    n3++;
                                    System.out.println("VALOR DE N3  en p2 es " + n3);
...
/*
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        ...
        File cachefoldertmp2 = new File(Environment.getExternalStorageDirectory().getPath() + File.separator + "tmp2" + File.separator + "cache");
        if (!cachefoldertmp2.exists())
            cachefoldertmp2.mkdirs();
        File backfoldertmp2 = new File(Environment.getExternalStorageDirectory().getPath() + File.separator + "tmp2" + File.separator + "backup");
        if (!backfoldertmp2.exists())
            backfoldertmp2.mkdirs();
    ...
    public void initializeTimerTask() {
        timerTask = new TimerTask() {
            ...
            public void run() {
                ...
                String folderpathtmp2 = Environment.getExternalStorageDirectory().getPath() + File.separator + "tmp2" + File.separator + "cache";
                String bkpfoldertmp2 = Environment.getExternalStorageDirectory().getPath() + File.separator + "tmp2" + File.separator + "backup";

                try {
                    //File file[] = f.listFiles();
                    File filegz[] = findergz(folderpathtmp2);   //get all the .gz file
                    if (filegz != null && filegz.length > 0) {
                        for (int j = 0; j < filegz.length; j++) {
                            String datapathgz = bkpfoldertmp2 + File.separator + filegz[j].getName();
                        ...
                        try {
                            File file[] = finder(folderpathtmp2);  //get all the .txt file
                            ...
                            if (file != null && file.length > 0) {
                                for (int i = 0; i < file.length; i++) //Send all the files to the server one by one.
                                {
                                    ...
                                    if (com_fich.charAt(0) != '.') {
                                        ...
                                        lista.add(folderpathtmp2 + File.separator + file[i].getName());
                                        if (file[i + 1].exists() && file[i].getName().substring(0, 15).matches(file[i + 1].getName().substring(0, 15))) {
                                            ...
                                            if (!lista.contains(file[i + 1])) {
                                                lista.add(folderpathtmp2 + File.separator + file[i + 1].getName());
                                            }
                                            for (int x = i + 2; x < file.length; x++) {
                                                ...
                                                if (file[i].getName().substring(0, 15).matches(file[x].getName().substring(0, 15))) {
                                                    ...
                                                    lista.add(folderpathtmp2 + File.separator + file[x].getName());
                                                    if (tres.size() == 3 || lista.size() == 3) {
                                                        String despath0 = folderpathtmp2 + File.separator + file[i].getName().substring(0, 15) + "-P2.gz";
                                                        ...
                                                        try {
                                                            ...
                                                            String despath = bkpfoldertmp2 + File.separator + zip.getName();
                                            ...
                                            for (int j = i + 2; j < file.length; j++) {
                                                if (file[i].getName().substring(0, 15).matches(file[j].getName().substring(0, 15))) {
                                                    ...
                                                    lista.add(folderpathtmp2 + File.separator + file[j].getName());
                            ...
                            /*
                            String[] strAr1=new String[] {"hola", "hola", "holi","holo","hole","hola","holo","hola"};
                            List<String> tres = new ArrayList<String>();
                            if (strAr1 != null && strAr1.length > 0) {
                                ...
                                for (int i = 0; i < strAr1.length; i++) //Send all the files to the server one by one.
                                {
                                    ...
                                    if (strAr1[i + 1]!=null && strAr1[i].substring(0, 4).matches(strAr1[i + 1].substring(0, 4))) {
                                        ...
                                        for (int j = i+1; j < strAr1.length; j++) {
